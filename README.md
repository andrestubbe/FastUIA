# FastUIA 0.1.0 [ALPHA-2026-06] — � Native Windows UI Automation API for Java
...
**âš¡ High-performance, native Windows UI Automation (UIA) for Java.**
...
- **ðŸš€ Native Performance**  Direct UI Automation API access via JNI.
- **? Zero Overhead**  No polling, purely event-driven callbacks.
- **ðŸš€ Zero Dependencies**  Just requires Java 17+ and Windows.
- **ðŸš€ Object-Oriented**  Clean, type-safe API for elements and patterns.
